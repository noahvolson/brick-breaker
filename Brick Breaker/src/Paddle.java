...
class Paddle extends SolidObject{
	// Constants
	/**
	 ...
	 */
	public Paddle () {
		super(new Rectangle(PADDLE_WIDTH, PADDLE_HEIGHT),3);
	...
	public void moveTo (double newX, double newY) {
		...
		this.setBoundBox(new Rectangle(newX - PADDLE_WIDTH/2, newY - PADDLE_HEIGHT/2, PADDLE_WIDTH, PADDLE_HEIGHT));
	}
}
